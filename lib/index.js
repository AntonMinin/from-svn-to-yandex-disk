...
InitMod.prototype.run = function(){
    ...
    return new Promise(function(reslove, reject) {
        ...
        rmdir(self.svnRepo, function (err, dirs, files) {
            ...
            console.log('re-create: ' + self.svnRepo);
            reslove();
        });
    })
    ...
    .then(function(href) {
        ...
        return new Promise(function(reslove, reject){
            if (href) {
                ...
                console.log('removed: ' + self.rootFolder);
                reslove();
            }
    ...
    .then(function(response) {
        ...
        return new Promise(function(reslove, reject) {
            request.put({
                ...
                console.log('created: ' + self.rootFolder);
                reslove();
            });
        })        
    })
...
function eachUpload(file, index, files, cb){
    try{
        ...
        console.log('Ошибка в процессе загрузки файла на Ya.Disk_1');
        console.error(e);
    }
}
...
function uploadFile(opts){
    ...
    .then(function(data) {
        ...
        return new Promise(function(reslove, reject) {
            ...
            .on('response', function(response) {
                try{
                    console.log('loaded: ' + data.file.fullPath);
                    if (typeof (data.callback) === 'function') data.callback();                        
                } catch (e){
                    console.log('Ошибка в процессе загрузки файла на Ya.Disk_2');
                    console.error(e);
                }
            }));
        });
    ...
    .catch(function(err){
        console.log('Ошибка в процессе загрузки файла на Ya.Disk_3');
        console.log(err);
    });  
}
